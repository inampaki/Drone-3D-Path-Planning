...
from utils import get_long_lat, plot_route
...
if __name__ == "__main__":
    ...
    parser.add_argument('--goal_lat', type=float, help='Goal position latitude must be float')
    parser.add_argument('--goal_lon', type=float, help='Goal position longitude must be float')
    parser.add_argument('--goal_alt', type=float, help='Goal position altitude must be float')
